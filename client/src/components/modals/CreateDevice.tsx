...
/**
 * @CreateDevice - создание  девайса на странице админа
 * @param show
 * @param onHide
...
const CreateDevice = observer(({show, onHide}:any) => {
    ...
    /**
     * @AddInfo - добавление инфы о товаре
     */
    const addInfo = () => {
        setInfo([...info, {title: '', description: '', number: Date.now()}])
    }
    /**
     * Удалить полее ввода инфы о товаре
    ...
    /**
     * Изменить информацию о девайсе
     * @param key - ключ девайса
